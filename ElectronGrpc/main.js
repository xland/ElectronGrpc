...
var require_server_credentials = __commonJS({
  "node_modules/@grpc/grpc-js/build/src/server-credentials.js"(exports2) {
    ...
    var InsecureServerCredentials = class extends ServerCredentials2 {
      _isSecure() {
        return false;
      }
      _getSettings() {
    ...
    var SecureServerCredentials = class extends ServerCredentials2 {
      constructor(options) {
        super();
        this.options = options;
      }
...
var startMainWindow = () => {
  ...
  mainWindow.loadURL(import_path.default.join(process.cwd(), "./index.html"));
};
var sayHello = (call, callback) => {
  callback(null, { message: "Hello " + call.request.name });
};
var startGrpcServer = () => {
  let server = new grpc.Server();
  let protoPath = import_path.default.join(process.cwd(), "helloworld.proto");
